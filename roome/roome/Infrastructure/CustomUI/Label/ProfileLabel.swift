...
class ProfileLabel: UILabel {
    ...
    convenience init(padding: UIEdgeInsets = UIEdgeInsets(top: 6.0, left: 12.0, bottom: 6.0, right: 12.0) , text: String?, isIntroduceLine: Bool = false) {
        self.init()
        self.text = text
        configureLabel()
        if isIntroduceLine {
    ...
    func configureLabel() {
        ...
        self.font = UIFont().pretendardBold(size: .body1)
